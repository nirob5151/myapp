...
class _HarvestersPageState extends State<HarvestersPage> {
  ...
  List<Equipment> _allHarvesters = [];
  List<Equipment> _filteredHarvesters = [];
  ...
  void _loadEquipment() {
    ...
    _equipmentSubscription = equipmentService.getEquipment().listen((allEquipment) {
      if (mounted) {
        setState(() {
          _allHarvesters =
              allEquipment.where((e) => e.category.toLowerCase() == 'harvesters').toList();
          _filterEquipment();
           _isLoading = false;
        });
      }
  ...
  void _filterEquipment() {
    ...
    setState(() {
      _filteredHarvesters = _allHarvesters.where((equipment) {
                    ...
                    child: Container(
                      ...
                      child: DropdownButtonHideUnderline(
                        child: DropdownButton<String>(
                          ...
                          items: <String>['All', 'John Deere', 'Claas']
                              .map((String value) {
                  ...
                  : _filteredHarvesters.isEmpty
                      ...
                      : ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          final equipment = _filteredHarvesters[index];
