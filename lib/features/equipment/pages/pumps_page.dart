...
class _PumpsPageState extends State<PumpsPage> {
  ...
  List<Equipment> _allPumps = [];
  List<Equipment> _filteredPumps = [];
  ...
  void _loadEquipment() {
    ...
    _equipmentSubscription = equipmentService.getEquipment().listen((allEquipment) {
      if (mounted) {
        setState(() {
          _allPumps = 
              allEquipment.where((e) => e.category.toLowerCase() == 'pump').toList();
          _filterEquipment();
          _isLoading = false;
        });
      }
  ...
  void _filterEquipment() {
    ...
    setState(() {
      _filteredPumps = _allPumps.where((equipment) {
                    ...
                    child: Container(
                      ...
                      child: DropdownButtonHideUnderline(
                        child: DropdownButton<String>(
                          ...
                          items: <String>['All', 'Kirloskar', 'Crompton']
                              .map((String value) {
                  ...
                  : _filteredPumps.isEmpty
                      ...
                      : ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          final equipment = _filteredPumps[index];
