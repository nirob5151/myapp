...
class _PumpsPageState extends State<PumpsPage> {
  ...
  final List<Equipment> _allEquipment = [
     Equipment(
        id: '7',
        name: 'Pump for Rent - Kirloskar',
        description: 'A powerful and versatile pump.',
        price: 100,
        imageUrl: 'https://5.imimg.com/data5/ANDROID/Default/2023/2/SE/EV/OH/42793129/product-jpeg-500x500.jpg',
        ownerId: 'dummy_owner',
        isAvailable: true,
        availableDates: [],
        category: 'Kirloskar',
      ...
      Equipment(
        id: '8',
        name: 'Pump for Rent - Crompton',
        description: 'High-performance pump with a comfortable cab.',
        price: 120,
        imageUrl: 'https://cdn.moglix.com/p/I/D/5/d/CRI-4-inch-Borewell-Submersible-Pump-CRI4R-3-07-1-Phase-I-D-5-d-image-20211101-1635749449852.jpg',
        ownerId: 'dummy_owner',
        isAvailable: true,
        availableDates: [],
        category: 'Crompton',
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Pump', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
        elevation: 0,
      ),
      body: Column(
            children: [
                      ...
                      child: Container(
                        ...
                        child: DropdownButtonHideUnderline(
                          child: DropdownButton<String>(
                            ...
                            items: <String>['All', 'Kirloskar', 'Crompton'].map((String value) {
