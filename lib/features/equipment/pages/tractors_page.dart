...
class _TractorsPageState extends State<TractorsPage> {
  ...
  List<Equipment> _allTractors = [];
  List<Equipment> _filteredTractors = [];
  ...
  void _filterEquipment() {
    ...
    setState(() {
      _filteredTractors = _allTractors.where((equipment) {
        final nameMatch = equipment.name.toLowerCase().contains(searchQuery);
        final subCategoryMatch = _selectedCategory == null || _selectedCategory == 'All' || equipment.name.toLowerCase().contains(_selectedCategory!.toLowerCase());
          ...
          children: [
            ...
            Expanded(
              child: _isLoading
                  ...
                  : _filteredTractors.isEmpty
                      ? const Center(child: Text('No tractors found.'))
                      : ListView.builder(
                          padding: const EdgeInsets.symmetric(horizontal: 16.0),
                          itemCount: _filteredTractors.length,
                          itemBuilder: (context, index) {
                            final equipment = _filteredTractors[index];
